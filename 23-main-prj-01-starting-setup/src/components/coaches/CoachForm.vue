<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{ invalid: !firstName.isValid }">
      ...
      />
      <p v-if="!firstName.isValid">Firstname is required field.</p>
    </div>
    ...
    <div class="form-control" :class="{ invalid: !lastName.isValid }">
      ...
      />
      <p v-if="!lastName.isValid">Lastname is required field.</p>
    </div>
    ...
    <div class="form-control" :class="{ invalid: !description.isValid }">
      ...
      ></textarea>
      <p v-if="!description.isValid">Description is required field.</p>
    </div>
    ...
    <p v-if="!formIsValid">
      Please fix the above errors and try register again.
    </p>
